          ...
          >
            ...
            <Box>
              ...
              <Box display="flex" alignItems="center" mt={4}>
                <Link className="avatar-img-ml avatar-img" href="https://trustseal.enamad.ir/Error/ErrorReferrer">
                  <Typography  className="icon-enamad" component="span"/>
                </Link>
                
                <Link className="avatar-img" href="https://logo.samandehi.ir/Verify.aspx?id=1015956&ampp=rfthobpdrfthdshwpfvldshwgvka">
                <Typography  className="icon-samandehi" component="span"/>
                </Link>
              </Box>
            </Box>
          </Grid2>
