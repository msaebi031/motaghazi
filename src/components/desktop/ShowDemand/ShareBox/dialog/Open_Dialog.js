...
const Open_Dialog = () => {
  ...
  // ======= Items ======== //
  const items = [
    t("show-demand.shareBox.dialog.items.textOne"),
    t("show-demand.shareBox.dialog.items.textTwo"),
    t("show-demand.shareBox.dialog.items.textThree"),
    t("show-demand.shareBox.dialog.items.textFour"),
    t("show-demand.shareBox.dialog.items.textFive"),
    t("show-demand.shareBox.dialog.items.text"),
  ];
  ...
  return (
    <Fragment>
      ...
      >
        <DialogContent
          sx={{ height: "370px", width: { md: "300px", lg: "350px" } }}
        >
          ...
          >
            ...
            >
              <Container className="d-flex align-center" maxWidth="sm">
                <IconButton onClick={() => dispatch(handleOpenDialog())}>
            ...
            <Container className="box-dialog-mob" maxWidth="sm">
              <Typography
                ...
                variant="body2"
              >
                {t("show-demand.shareBox.dialog.reason")}
              </Typography>
              <Box
                className="box-dialog-mob"
                py={1}
                display="grid"
                mt={1.5}
          ...
          >
            <IconButton
              ...
              className="btn-clearmodalOne-left"
              aria-label="delete"
              size="small"
            >
              <Clear color="light" />
                ...
                >
                  {items.map((item, index) => (
                    <FormControlLabel
                      key={index}
                      value={item}
                      control={<Radio required color="info" />}
                      label={item}
                    />
                  ))}
                </RadioGroup>
